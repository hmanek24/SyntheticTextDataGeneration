...
MODEL='run1'
MODELS_DIR=$HOME/CSCI544/Project/SyntheticMedicalDataGeneration/gpt2/gpt-2/models
...
python src/generate_conditional_samples.py --input_file $INPUT_FILE --output_file $OUTPUT_FILE --model_name $MODEL --models_dir $MODELS_DIR --top_k $TOP_K --temperature $TEMP --batch_size $BS
